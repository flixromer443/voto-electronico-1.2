...
<a href="../Index.php" style="color: white;"><button class="btn btn-link"><i class="fas fa-arrow-left" style="font-size: 30px; color:white"></i> </button></a>
  <a class="navbar-brand" href="#">Administrador de listas</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="Adminlistas/Estadisticas.php">Estadisticas</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="Adminlistas/Generarlistas.php">Generar listas</a>
      </li>
    </ul>
  </div>
</nav>
    ...
    <br><br>
     ...
     while($campos=fgetcsv($archivo,999,"\t")){
        ...
        foreach($campos as $campo){
           ...
           <div class='modal-dialog'>
             <div class='modal-content'>
               ...
               <div class='modal-body'>
                ¿deseas eliminar la lista $campos[0]: $campos[1]?
               </div>
         ...
         <td>
                <button  data-toggle='modal' data-target='#exampleModal$campos[0]' style='width:50px; height:35px' type='submit' value='Eliminar'class='btn btn-danger' onclick='cambiar();'>
                    <svg width='1em' height='1em' viewBox='0 0 16 16' class='bi bi-trash' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
                        <path d='M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z'/>
                        <path fill-rule='evenodd' d='M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z'/>
                        </svg>
                    </button>
            <a href='Adminlistas/Editar.php?id=$campos[0]'>
    ...
    <div class="col-sm-3">
        ...
        <form  class="formulario" action="../Acciones/Cerraradmin.php" method="POST">
            <input type="submit" class="btn btn-light" name="Cerrar_sesion" value="Cerrar sesion">
        </form>
    </div>
