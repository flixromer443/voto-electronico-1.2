function voto4(){
    document.getElementById("formu4").style.display="none";
    document.getElementById("backgound4").addEventListener("click",function(){
        document.getElementById("formu4").style.display="block";
        console.log("en voto4")
